    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'School'), (2, 'Student')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_ans_option_1', models.BooleanField(default=True)),
                ...
                ('quiz_ref', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Task.quiz')),
            ],
        ),
    ]
